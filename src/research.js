    ...
    title: {
      content: (
        <Header as="h3" size="large">
          ...
          <Header.Subheader>
            <p>
              No. Shepherd’s Run will improve the local environment by removing
              pesticides from the soil and water, decreasing erosion, and
      ...
      content: (
        <Container>
          <p>
            ...
            impact. Let’s examine each concern, keeping in mind that by law, New
            York State’s Department of Environment Conservation won’t authorize
            the project unless Hecate can{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <p>
            🧪 &nbsp;&nbsp; <b>Fewer pesticides</b>: The farms at Shepherd’s Run
            currently use pesticides to grow corn, according to the land owners.
            Pesticides can be toxic to animals and{" "}
            <a
              target="_blank"
              rel="noreferrer"
          ...
          <p>
            ...
            compared to farms. So Shepherd’s Run should significantly reduce the
            amount of runoff into Taghkanik Creek.
          </p>
          <p>
          ...
          <p>
            ...
            materials, so Shepherd’s Run shouldn’t hurt the quality of Copake’s
            water. It will likely improve it, by reducing erosion and removing
            cow dung and corn pesticides.
          </p>
          <p>
          ...
          <p>
            ...
            Shepherd’s Run site. According to Hecate, the small number of trees
            that dot the farm may be removed, but none of the forest groves that
            surround it will be cleared. And new trees will be planted around
            the facility to protect views.
          </p>
        </Container>
      ),
    },
    ...
    content: {
      content: (
        <Container>
          ...
          <p>
            Letting that soil rest, and planting native vegetation, will restore
            its{" "}
            <a
              rel="noreferrer"
              target="_blank"
          ...
          <p>
            ...
            <br />
            To preserve farms, you need to suppot farmers. Unfortunately, farms
            in the Hudson Valley have been declining for decades.
          </p>
          <p>
            <iframe
              title="pubchart"
          ...
          <p>
            To reverse this trend, farmers need new ways of making money. Solar
            farms are a great financial lifeline: they provide steady income and
            improve soil quality, which helps farmers stay in business for the
            long-term.
          </p>
          <p>
          ...
          <p>
            ...
            land, and no permanent structures will be built on the property, so
            there’s nothing preventing the owners from going back to farming
          ...
          <p>
            Shepherd’s Run could change that. As part of the project, the owners
            could attach a &nbsp;
            <a
              rel="noreferrer"
              target="_blank"
            ...
            anything other than farming and clean energy, even if it gets sold.
          </p>
        </Container>
      ),
    },
    ...
    title: {
      content: (
        <Header as="h3" size="large">
          ...
          <Header.Subheader>
            <p>
              No, Shepherd’s Run native plants will help birds and solar panels
          ...
          <p>
            ...
            <ol>
              ...
              <li>
                ...
                from climate change. Large solar farms that take a real bite out
                of the problem are essential for protecting them. That’s why the
    ...
    content: {
      content: (
        <Container>
          ...
          <p>
            However, to avoid the liability of people running around between the
            panels, Hecate is required to fully fence in the solar farm. Small
            animals — as well as deer, bears, and other large animals — will
            need to go around the fence.
          </p>
          <p>
      ...
      content: (
        <Container>
          ...
          <p>
            ...
            Our community needs a lot of electricity, but produces very little.
            So any new power produced here would stay here, satisfying our
            electricity needs and replacing what we take from others.
          </p>
          <p>
    ...
    title: {
      content: (
        <Header as="h3" size="large">
          ...
          <Header.Subheader>
            <p>
              We don’t know the visual impact yet, but Hecate is taking steps to
              minimize it.
            </p>
          </Header.Subheader>
        </Header>
      ...
      content: (
        <Container>
          <p>
            ...
            to minimizing the impact on views as much as possible. To that end,
            they are currently surveying the area to figure out where to add
            trees and where to remove panels.
          </p>
          <p>
      ...
      content: (
        <Container>
          <p>
            ...
            Copake, Copake Lake, Copake Falls, or West Copake. So many tourists
            won’t see the panels at all.
          </p>
          <p>
          ...
          <p>
            Of course, some tourists will drive or bike through Center Hill Road
            and Route 7, but this will be a small fraction of those who visit
            us.
          </p>
        </Container>
      ),
      ...
      content: (
        <Container>
          <p>
            ...
            the impact of solar farms on property values.* But here’s what we do
            know.
          </p>
          <br />
          <p>
          ...
          <p>
            <em>
              ...
              nbsp;
              <b>effectively zero</b> (a statistically insignificant 0.1%), and
              that the negative externalities of solar arrays are only occurring
              in non-rural areas. These findings go against our intuition.” (
              <a
                rel="noreferrer"
                target="_blank"
          ...
          <p>
            This isn’t ideal. Understandably, nobody wants their property value
            to go down.
          </p>
          <p>
            But thankfully, it shouldn’t jeopardize anyone’s finances either. If
            your home is worth $250k, and the property value goes down by 2%, it
            would still be worth $245k.
          </p>
          <br />
          <p>
          ...
          <p>
            ...
            values we’ve seen in Columbia County since the start of the pandemic
            (Feb 2020-Feb 2021).
          </p>
          <p>
          ...
          <p>
            <i>
              * We found only{" "}
              ...
              by economists that actually measured the impact of solar farms on
              nearby home sales. The study used real data on 419,000 home sales,
              and used statistical models to compare the prices of homes near
              solar farms with those of similar homes elsewhere. This is the
              gold standard for quantifying the effect of disamenities on
              property values.
            </i>
          </p>
          <p>
          ...
          <p>
            <i>
              Despite those flaws, the study concludes: “Results from our survey
              of home assessors show that the majority of respondents believe
              that proximity to a solar installation either had no impact or
      ...
      content: (
        <Container>
          <p>
            ...
            . We know this because, even though the US doesn’t track solar panel
            fires, other countries do: In the past 20 years, only{" "}
            <a
              rel="noreferrer"
              target="_blank"
          ...
          <p>
            Moreover, Hecate is required to pay special district property taxes
            to the Fire Department. So the fire department will actually get a
            significant funding boost in exchange for a minuscule increase in
            fire risk.
          </p>
        </Container>
      ),
      ...
      content: (
        <Container>
          ...
          <p>
            ...
            with local zoning rules, because{" "}
            <a
              rel="noreferrer"
              target="_blank"
      ...
      content: (
        <Container>
          ...
          <p>
            ...
            New York State, according to solar power expert Dr. Richard Perez of
            SUNY Albany. If we put panels on half of all buildings and parking
            lots in in the state, that would amount to only 160 square miles.
      ...
      content: (
        <Container>
          ...
          <p>
            ...
            York’s electricity. Otherwise, solar developers can’t compete, and
          ...
          <p>
            ...
            expensive than natural gas, which is a deal-breaker. But even if it
            was cheap, there aren’t anywhere close to enough brownfields out
            there.
          </p>
          <p>
            There are{" "}
          ...
          <p>
            So while brownfield projects are worth exploring, they unfortunately
            cannot substitute for rural solar farms.
          </p>
        </Container>
      ),
    },
      ...
      content: (
        <Container>
          <p>
            ...
            interested landowners isn’t so simple. The Craryville substation has
            both.
          </p>
        </Container>
      ),
    ...
    content: {
      content: (
        <Container>
          ...
          <p>
            So the project needs to be close to the Craryville substation or the
            project doesn’t make sense financially, and we’ll end up with more
    ...
    content: {
      content: (
        <Container>
          ...
          <p>
            But Shepherd’s Runs still needs to be hundreds of acres, not dozens.
            For two reasons: cost and scale.
          </p>
          <p>
          ...
          <p>
            ...
            still need to uild <b>411</b> solar farms the size of Shepherd’s Run
            to get the job done. <b>44%</b> of New York’s 932 towns would have a
            big solar farms!
          </p>
          <p>
            ...
            take years to get approval, even small ones. There isn’t enough time
            to blanket the New York in 10 acre projects.
          </p>
          <p>
            So Shepherd’s Run isn’t actually too big. It’s just right. If you’re
            serious about fighting climate change, this is what a real climate
            solution looks like.
          </p>
        </Container>
      ),
      ...
      content: (
        <Container>
          <p>
            ...
            right into the last two problems we encountered: Small projects far
            from substations are too expensive to beat fossil fuels.
          </p>
        </Container>
      ),
    },
