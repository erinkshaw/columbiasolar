    ...
    <>
      <Container>
        ...
        <Header as="h3">🏛️ Contact the State and Town</Header>
          ...
          <p>You might mention how it will <a target="_blank" href="">benefit Copake</a>, and how our State needs
          hundreds of large solar farms to solve the climate crisis. Include what town you live in.</p> 
          <p>
          <b>Step</b> 2️⃣
           <ul>
             <li>
             <a target="_blank" href="http://documents.dps.ny.gov/public/Comments/PublicComments.aspx?MatterCaseNo=20-F-0048">
               Submit
            </a> your message to the New York State Siting Board that will decide on the project.
             </li>
             <li>Email your message to Copake's State Legislators: <strong>Senator Daphne Jordan</strong> (jordan@nysenate.gov) and <strong>Assemblymember Didi Barrett</strong> (barrettd@nyassembly.gov)</li>
             <li>Email your message to Copake's Town Board, if you live in Copake: <strong>Supervisor Jeanne Metler</strong> (copakesupervisor@fairpoint.net) and <strong>Deputy Supervisor Richard Wolf</strong> (copakedepsupervisor@fairpoint.net)</li>
           </ul>
        </p>
      </Container>
      <Footer />
